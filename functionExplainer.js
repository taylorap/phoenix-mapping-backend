...
// here between the backticks, starting at
...
const SYSTEM_PROMPT = `
# Phoenix Mapping Function Explainer (Agent / System Prompt)

Use the following as the Agent / System prompt when you create a new Cursor agent.
...
RESO Field Name: [[RESO Field Name]]
...
- When possible, also translate briefly what they represent (for example: “the MLS field LIST_117 (garage spaces)”).
...
/**
 * Call the LLM to explain a single JavaScript mapping function.
 *
 * @param {string} fieldName - RESO standardName (e.g. "UnparsedAddress")
 * @param {string} functionBody - the JS function text
 * @returns {Promise<string|null>} - plain-text explanation or null
 */
